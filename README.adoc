...
:url-project: https://github.com/anoff/antora-ui-bootstrap
...
This UI is based on the link:{url-default-ui}[antora-ui-default] originally licensed under
----
...
Any modifications are licensed by Andreas Offenhaeuser under the identical MPL-2.0 license.
